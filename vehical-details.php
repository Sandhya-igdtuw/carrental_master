      ...
      <aside class="col-md-3">
        ...
        <?php
          ...
          if ($results == 0) {
            ...
            <h5><i class="fa fa-envelope" aria-hidden="true"></i>Rent Car</h5>
          </div>
          <form method="post">
            ...
            <select class="form-control" name="days" id="days" >
              <option value="" disabled selected>Number of Days For Rent</option>
              <?php
              for ($i=1; $i<=100; $i++)
              {
              ?>
          ...
          <?php if($_SESSION['login'])
              {?>
              <div class="form-group">
                <input type="submit" class="btn"  name="submit" value="Rent Car">
              </div>
              <?php } else { ?>
